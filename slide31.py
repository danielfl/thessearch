...
texto2="""For semantic indexing we proposed the semantic pathﬁnder,for details see [4]. 
...
texto="""The Internet is now a household term in many countries. With otherwise serious people 
